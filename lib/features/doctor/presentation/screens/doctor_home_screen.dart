...
class _DoctorHomeScreenState extends State<DoctorHomeScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildPatientTable(isDark, context, vm),
                ...
                children: [
                  ...
                  Expanded(
                    child: _buildIndicatorCard(
                      ...
                      value: '${vm.avgGlucose.toStringAsFixed(0)} mg/dL',
                      isDark: isDark,
                    ),
                  ),
                ],
  ...
  Widget _buildPatientTable(bool isDark, BuildContext context, DoctorHomeViewModel vm) {
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            // Filas de pacientes
            ...vm.patients.map((patient) => _buildPatientRow(
                  patientData: patient,
                  isDark: isDark,
                  context: context,
                )),
